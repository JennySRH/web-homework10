window.onload = function () {
    ...
    $(".apb").click(function () {
        ...
        $("#a").triggerHandler('click',function() {
            $("#b").triggerHandler('click',function() {
                $("#c").triggerHandler('click',function(){
                    $("#d").triggerHandler('click',function() {
                        $('#e').triggerHandler('click',function() {
